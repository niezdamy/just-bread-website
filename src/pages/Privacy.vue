...
en:
  ...
  website_text: The website stores your analytics preference in local storage. If you consent to analytics, PostHog may process technical and usage data, including pages viewed, page URL, app-store link clicks, browser and device information, approximate location inferred from IP address, and timestamps.
  ...
  analytics_text: PostHog is activated only after consent. Without consent, analytics is not initialized in the app or on the website. When consent is withdrawn, the app or website opts out of further analytics collection. App functionality is not conditional on granting analytics consent.
  cookies_title: Cookies
  cookies_text: We use local storage to remember your analytics choice. When enabled, PostHog may use cookies or similar technologies to provide analytics. You can change your choice at any time below or clear your browser storage.
  providers_title: Service Providers
  providers_text: "We use the following service provider:"
  provider_1: PostHog, Inc. - website analytics.
  provider_2: PostHog data is sent to its EU service endpoint.
  provider_3: The provider processes data on our behalf to deliver analytics.
  provider_4: Its processing is subject to the provider's applicable data-processing terms.
  ...
  analytics_description: This control applies to analytics on this website. In the mobile app, you can change the equivalent setting in the app. With consent, PostHog measures page views and clicks on app-store links.
...
pl:
  ...
  intro_2: Szanujemy Twoja prywatnosc. Analityka jest opcjonalna i wlaczana wylacznie po wyrazeniu zgody.
  ...
  website_text: Strona zapisuje w local storage Twoj wybor dotyczacy analityki. Po wyrazeniu zgody PostHog moze przetwarzac dane techniczne i dane o korzystaniu, w tym odwiedzane strony, adres URL, klikniecia w linki do sklepow z aplikacjami, informacje o przegladarce i urzadzeniu, przyblizona lokalizacje wnioskowana z adresu IP oraz znaczniki czasu.
  ...
  analytics_text: PostHog jest uruchamiany dopiero po wyrazeniu zgody. Bez zgody analityka nie jest inicjalizowana ani w aplikacji, ani na stronie. Po wycofaniu zgody aplikacja lub strona rezygnuje z dalszego zbierania danych analitycznych. Dzialanie aplikacji nie zalezy od wyrazenia zgody na analityke.
  cookies_title: Pliki cookie
  cookies_text: Korzystamy z local storage, aby zapamietac Twoj wybor dotyczacy analityki. Po jej wlaczeniu PostHog moze uzywac plikow cookie lub podobnych technologii. Wybor mozesz zmienic ponizej lub wyczyscic dane przegladarki.
  providers_title: Usugodawcy zewnetrzni
  providers_text: "Korzystamy z nastepujacego uslugodawcy:"
  provider_1: PostHog, Inc. - analityka strony internetowej.
  provider_2: Dane PostHog sa wysylane do europejskiego punktu dostepowego uslugi.
  provider_3: Dostawca przetwarza dane w naszym imieniu, aby swiadczyc analityke.
  provider_4: Przetwarzanie podlega obowiazujacym warunkom przetwarzania danych dostawcy.
  ...
  analytics_description: Ten wybor dotyczy analityki na tej stronie. W aplikacji mobilnej mozesz zmienic analogiczne ustawienie w aplikacji. Za zgoda PostHog mierzy odslony podstron i klikniecia w linki do sklepow z aplikacjami.
  analytics_disable: Wylacz analityke
  analytics_enable: Wlacz analityke
  analytics_status_enabled: Analityka jest wlaczona.
  analytics_status_disabled: Analityka jest wylaczona.
</i18n>